...
public class Pixel {
         ...
         *
         * @param The red component as an int from 0-255
         */
         ...
         *
         * @param The green component as an int from 0-255
         */
         ...
         *
         * @param The blue component as an int from 0-255
         */
         ...
         *
         * @param The alpha component as an int from 0-255
         */
